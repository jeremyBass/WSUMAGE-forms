<?php
class Wsu_WebFormsCRF_CheckoutController extends Mage_Core_Controller_Front_Action{
	...
	public function billingAction(){
		...
		$result = array( 'success' => false, 'errors' => array(), 'success_text' => '', 'redirect_url' => '', 'script' => '',);
		...
		if(!count($errors)){
			...
			if($result_id){
				...
				$result['success'] = true;
				$result['script'] = " billing.save(); $('result_id').setValue({$result_id}); ";
			} 
		} 
		$result['script'] .= " $$('#billing-buttons-container .button')[0].enable(); Recaptcha.reload(); ";		
