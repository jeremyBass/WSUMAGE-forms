<?php
class Wsu_WebForms_Block_Webforms extends Mage_Core_Block_Template {
	protected $_webform;
	...
	protected function initForm() {
		...
		//get form data
		$webform      = Mage::getModel('webforms/webforms')->setStoreId(Mage::app()->getStore()->getId())->load($data['webform_id']);
	...
	public function getCaptcha() {
		return Mage::helper('wsu_networksecurities')->getCaptcha();
	}
	...
	public function getFormAction() {
		if ($this->isAjax()) {
			...
			return $this->getUrl('webforms/index/iframe', array(
				'_secure' => $secure
			));
		}
