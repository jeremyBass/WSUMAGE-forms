<?php
class Wsu_WebForms_Block_Adminhtml_Fields_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
	...
	protected function _beforeToHtml() {
		...
		Mage::dispatchEvent('webforms_adminhtml_fields_edit_tabs_before_to_html', array(
			'tabs' => $this
		));
