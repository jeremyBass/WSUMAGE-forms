<?php
class Wsu_WebForms_Block_Adminhtml_Fields_Edit_Tab_Logic extends Mage_Adminhtml_Block_Widget_Grid {
	...
	public function getGridUrl() {
		return $this->getUrl('*/adminhtml_logic/grid', array(
	...
	protected function _prepareMassaction() {
		...
		Mage::dispatchEvent('webforms_adminhtml_fields_logic_grid_prepare_massaction', array(
			'grid' => $this
		));
		return $this;
	}
