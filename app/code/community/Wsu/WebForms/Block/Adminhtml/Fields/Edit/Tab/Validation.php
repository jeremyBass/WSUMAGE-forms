<?php
class Wsu_WebForms_Block_Adminhtml_Fields_Edit_Tab_Validation extends Mage_Adminhtml_Block_Widget_Form {
	...
	protected function _prepareForm() {
		...
		Mage::dispatchEvent('webforms_adminhtml_fields_edit_tab_design_prepare_form', array(
			'form' => $form,
			'fieldset' => $fieldset
		));
