<?php
class Wsu_WebForms_Block_Adminhtml_Fields_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
	protected function _prepareLayout() {
		...
		if (!Mage::app()->isSingleStoreMode() && $this->getRequest()->getParam('id')) {
			...
			$this->getLayout()->getBlock("left")->append($store_switcher);
		}
		// add scripts
	...
	public function getSaveUrl() {
		return $this->getUrl('*/adminhtml_webforms/save', array(
	...
	public function getAddLogicUrl() {
		return $this->getUrl('*/adminhtml_logic/new', array(
