<?php
class Wsu_WebForms_Block_Adminhtml_Reply_Results extends Mage_Adminhtml_Block_Widget_Grid {
	...
	protected function _prepareCollection() {
		...
		$collection = Mage::getModel('webforms/results')->getCollection()->addFieldToFilter('id', $Ids);
