<?php
class Wsu_WebForms_Block_Adminhtml_Logic_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
	protected function _prepareLayout() {
		...
		Mage::dispatchEvent('webforms_adminhtml_logic_edit_form_prepare_layout', array(
			'form' => $form
		));
		$this->setForm($form);
	}
