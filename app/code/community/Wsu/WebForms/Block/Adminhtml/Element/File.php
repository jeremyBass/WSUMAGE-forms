<?php
class Wsu_WebForms_Block_Adminhtml_Element_File extends Varien_Data_Form_Element_Abstract {
	...
	public function getElementHtml() {
		...
		$element = sprintf('<input id="%s" name="%s" %s />%s', $this->getHtmlId(), $this->_getName(), $this->serialize($this->getHtmlAttributes()), $this->getAfterElementHtml());
