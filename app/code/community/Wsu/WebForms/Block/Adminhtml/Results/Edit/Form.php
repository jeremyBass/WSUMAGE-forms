<?php
class Wsu_WebForms_Block_Adminhtml_Results_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
	...
	protected function _prepareLayout() {
		...
		$fieldset      = $form->addFieldset('result_info', array(
			'legend' => Mage::helper('webforms')->__('Result # %s', $result->getId())
		));
		...
		$fieldset->addField('info_webform_name', 'link', array(
			...
			'href' => $this->getUrl('*/adminhtml_webforms/edit', array(
				'id' => $webform->getId()
			)),
