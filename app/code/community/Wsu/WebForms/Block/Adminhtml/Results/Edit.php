<?php
class Wsu_WebForms_Block_Adminhtml_Results_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
	...
	public function __construct() {
		...
		$this->_addButton('reply', array(
			...
			'onclick' => 'setLocation(\'' . $this->getUrl('*/*/reply', array(
				'_current' => true,
	...
	public function getBackUrl() {
		return $this->getUrl('*/adminhtml_results/index', array(
			'webform_id' => Mage::registry('result')->getWebformId()
		));
	}
