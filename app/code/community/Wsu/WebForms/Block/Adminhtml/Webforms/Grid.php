<?php
class Wsu_WebForms_Block_Adminhtml_Webforms_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	...
	protected function _prepareCollection() {
		...
		Mage::dispatchEvent('webforms_adminhtml_webforms_grid_prepare_collection', array(
			'grid' => $this
		));
	...
	protected function _prepareColumns() {
		...
		$this->addColumn('fields', array(
			...
			'index' => 'fields',
			'type' => 'number',
			'renderer' => 'Wsu_WebForms_Block_Adminhtml_Webforms_Renderer_Fields',
			'sortable' => false,
			'filter' => false
		));
		$this->addColumn('results', array(
			...
			'index' => 'results',
			'type' => 'number',
			'renderer' => 'Wsu_WebForms_Block_Adminhtml_Webforms_Renderer_Results',
			'sortable' => false,
			'filter' => false
		));
		...
		$this->addColumn('last_result_time', array(
			...
			'type' => 'number',
			'renderer' => 'Wsu_WebForms_Block_Adminhtml_Webforms_Renderer_Lastresult',
			'filter' => false,
			'sortable' => false
		));
		$this->addColumn('action', array(
			...
			'filter' => false,
			'sortable' => false,
			'renderer' => 'Wsu_WebForms_Block_Adminhtml_Webforms_Renderer_Action',
			'is_system' => true
		));
		Mage::dispatchEvent('webforms_adminhtml_webforms_grid_prepare_columns', array(
			'grid' => $this
		));
	...
	protected function _prepareMassaction() {
		...
		Mage::dispatchEvent('webforms_adminhtml_webforms_grid_prepare_massaction', array(
			'grid' => $this
		));
		return $this;
	}
