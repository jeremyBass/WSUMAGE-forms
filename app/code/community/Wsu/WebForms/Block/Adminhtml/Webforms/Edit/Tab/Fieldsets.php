<?php
class Wsu_WebForms_Block_Adminhtml_Webforms_Edit_Tab_Fieldsets extends Mage_Adminhtml_Block_Widget_Grid {
	...
	public function getGridUrl() {
		return $this->getUrl('*/adminhtml_fieldsets/grid', array(
	...
	protected function _prepareColumns() {
		...
		Mage::dispatchEvent('webforms_adminhtml_webforms_tab_fieldsets_prepare_columns', array(
			'grid' => $this
		));
	...
	protected function _prepareMassaction() {
		...
		$this->getMassactionBlock()->addItem('delete', array(
			...
			'url' => $this->getUrl('*/adminhtml_fieldsets/massDelete', array(
		...
		$this->getMassactionBlock()->addItem('status', array(
			...
			'url' => $this->getUrl('*/adminhtml_fieldsets/massStatus', array(
				'webform_id' => $this->getParam('id'),
				'store' => $this->getRequest()->getParam('store')
			)),
			'additional' => array(
		...
		$this->getMassactionBlock()->addItem('duplicate', array(
			...
			'url' => $this->getUrl('*/adminhtml_fieldsets/massDuplicate', array(
				'webform_id' => $this->getParam('id')
			)),
