<?php
class Wsu_WebForms_Block_Adminhtml_Webforms_Edit_Tab_Settings extends Mage_Adminhtml_Block_Widget_Form {
	...
	protected function _prepareForm() {
		...
		$fieldset->addField('captcha_mode', 'select', array(
			...
			'values' => Mage::getModel('wsu_networksecurities/captcha_mode')->toOptionArray(true)
		));
		...
		Mage::dispatchEvent('webforms_adminhtml_webforms_edit_tab_settings_prepare_form', array(
			'form' => $form,
			'fieldset' => $fieldset
		));
