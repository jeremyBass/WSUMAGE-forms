<?php
class Wsu_WebForms_Block_Adminhtml_Webforms_Edit_Tab_Information extends Mage_Adminhtml_Block_Widget_Form {
	...
	protected function _prepareForm() {
		...
		Mage::dispatchEvent('webforms_adminhtml_webforms_edit_tab_information_prepare_form', array(
			'form' => $form,
			'fieldset' => $fieldset
		));
