<?php
class Wsu_WebForms_Block_Adminhtml_Webforms_Edit_Tab_Fields extends Mage_Adminhtml_Block_Widget_Grid {
	...
	public function getGridUrl() {
		return $this->getUrl('*/adminhtml_fields/grid', array(
	...
	protected function _prepareColumns() {
		...
		Mage::dispatchEvent('webforms_adminhtml_webforms_tab_fields_prepare_columns', array(
			'grid' => $this
		));
	...
	protected function _prepareMassaction() {
		...
		$this->getMassactionBlock()->addItem('delete', array(
			...
			'url' => $this->getUrl('*/adminhtml_fields/massDelete', array(
				'webform_id' => $this->getParam('id')
			)),
		...
		$this->getMassactionBlock()->addItem('status', array(
			...
			'url' => $this->getUrl('*/adminhtml_fields/massStatus', array(
				'webform_id' => $this->getParam('id'),
				'store' => $this->getRequest()->getParam('store')
			)),
			'additional' => array(
		...
		if (count($fieldsetsOptions) > 1) {
			$this->getMassactionBlock()->addItem('fieldset', array(
				...
				'url' => $this->getUrl('*/adminhtml_fields/massFieldset', array(
					'webform_id' => $this->getParam('id'),
					'store' => $this->getRequest()->getParam('store')
				)),
				'additional' => array(
		...
		$this->getMassactionBlock()->addItem('duplicate', array(
			...
			'url' => $this->getUrl('*/adminhtml_fields/massDuplicate', array(
				'webform_id' => $this->getParam('id')
			)),
