<?php
class Wsu_WebForms_Block_Adminhtml_Webforms_Edit_Tab_Logic extends Mage_Adminhtml_Block_Widget_Grid {
	...
	public function getGridUrl() {
		return $this->getUrl('*/adminhtml_webforms/logic', array(
			'webform_id' => $this->getRequest()->getParam('id'),
			'store' => $this->getRequest()->getParam('store')
		));
	}
	public function getRowUrl($row) {
		return $this->getUrl('*/adminhtml_logic/edit', array(
			'id' => $row->getId(),
			'webform_id' => $this->getRequest()->getParam('id'),
			'store' => $this->getRequest()->getParam('store')
		));
	...
	protected function _prepareColumns() {
		...
		$this->addColumn('value', array(
			...
			'index' => 'value',
			'renderer' => 'Wsu_WebForms_Block_Adminhtml_Logic_Renderer_Value'
		));
		...
		$this->addColumn('target', array(
			...
			'filter' => false,
			'index' => 'target',
			'renderer' => 'Wsu_WebForms_Block_Adminhtml_Logic_Renderer_Target'
		));
	...
	protected function _prepareMassaction() {
		...
		Mage::dispatchEvent('webforms_adminhtml_webforms_logic_grid_prepare_massaction', array(
			'grid' => $this
		));
		return $this;
	}
