<?php
class Wsu_WebForms_Block_Adminhtml_Fieldsets_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
	protected function _prepareLayout() {
		...
		Mage::dispatchEvent('webforms_adminhtml_fieldsets_edit_form_prepare_layout', array(
			'form' => $form,
			'fieldset' => $fieldset
		));
		$this->setForm($form);
