<?php
class Wsu_WebForms_Adminhtml_FieldsController extends Mage_Adminhtml_Controller_Action {
	...
	public function gridAction() {
		...
		$this->getResponse()->setBody($this->getLayout()->createBlock('webforms/adminhtml_webforms_edit_tab_fields')->toHtml());
	}
