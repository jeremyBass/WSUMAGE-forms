<?php
class Wsu_WebForms_Adminhtml_WebFormsController extends Mage_Adminhtml_Controller_Action {
	...
	public function logicAction() {
		...
		if ($webformsModel->getId() || $webformsId == 0) {
			...
			$this->loadLayout();
			$this->getResponse()->setBody($this->getLayout()->createBlock('webforms/adminhtml_webforms_edit_tab_logic')->toHtml());
		}
	}
