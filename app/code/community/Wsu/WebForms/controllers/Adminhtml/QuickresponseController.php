<?php
class Wsu_WebForms_Adminhtml_QuickresponseController extends Mage_Adminhtml_Controller_Action {
	public function indexAction() {
		$this->loadLayout();
		// add grid
		$this->getLayout()->getBlock('content')->append($this->getLayout()->createBlock('webforms/adminhtml_quickresponse'));
		$this->renderLayout();
	}
	public function gridAction() {
		$this->loadLayout();
		$this->getResponse()->setBody($this->getLayout()->createBlock('webforms/adminhtml_quickresponse_grid')->toHtml());
	}
	...
	public function editAction() {
		$this->loadLayout();
		// add grid
		$this->getLayout()->getBlock('content')->append($this->getLayout()->createBlock('webforms/adminhtml_quickresponse_edit'));
		$this->renderLayout();
	}
	public function saveAction() {
		if ($this->getRequest()->getPost()) {
			try {
				...
				if ($saveandcontinue) {
					$this->_redirect('*/adminhtml_quickresponse/edit', array(
