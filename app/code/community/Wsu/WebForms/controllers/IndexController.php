<?php
class Wsu_WebForms_IndexController extends Mage_Core_Controller_Front_Action {
	...
	public function iframeAction() {
		$webform = Mage::getModel('webforms/webforms')->setStoreId(Mage::app()->getStore()->getId())->load(Mage::app()->getRequest()->getPost("webform_id"));
		$result  = array(
			"success" => false,
			"errors" => array()
		);
		...
		Mage::dispatchEvent('webforms_controllers_index_iframe_action', array(
			'result' => $result,
			'webform' => $webform
		));
