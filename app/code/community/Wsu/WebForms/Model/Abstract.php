<?php
class Wsu_WebForms_Model_Abstract extends Mage_Core_Model_Abstract {
	...
	public function saveStoreData($store_id, $data) {
		$object = Mage::getModel('webforms/store')->search($store_id, $this->getEntityType(), $this->getId())->setStoreId($store_id)->setEntityType($this->getEntityType())->setEntityId($this->getId())->setStoreData(serialize($data))->save();
