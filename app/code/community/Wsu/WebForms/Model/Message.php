<?php
class Wsu_WebForms_Model_Message extends Mage_Core_Model_Abstract {
	public function _construct() {
		parent::_construct();
		$this->_init('webforms/message');
	}
	public function sendEmail() {
		$result = Mage::getModel('webforms/results')->load($this->getResultId());
		...
		$success = Mage::getModel('core/email_template')->setTemplateSubject($subject)->setReplyTo($result->getReplyTo('customer'))->sendTransactional($templateId, $sender, $email, $name, $vars, $storeId);
		return $success;
	}
}