<?php
class Wsu_WebForms_Model_Mysql4_Webforms extends Wsu_WebForms_Model_Mysql4_Abstract {
	...
	protected function _afterSave(Mage_Core_Model_Abstract $object) {
		Mage::dispatchEvent('webforms_after_save', array(
			'webform' => $object
		));
	...
	protected function _afterDelete(Mage_Core_Model_Abstract $object) {
		...
		Mage::dispatchEvent('webforms_after_delete', array(
			'webform' => $object
		));
		return parent::_afterDelete($object);
	}
	protected function _afterLoad(Mage_Core_Model_Abstract $object) {
		Mage::dispatchEvent('webforms_after_load', array(
			'webform' => $object
		));
