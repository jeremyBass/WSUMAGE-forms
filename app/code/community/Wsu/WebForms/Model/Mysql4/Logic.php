<?php
class Wsu_WebForms_Model_Mysql4_Logic extends Wsu_WebForms_Model_Mysql4_Abstract {
	...
	protected function _afterLoad(Mage_Core_Model_Abstract $object) {
		...
		Mage::dispatchEvent('webforms_logic_after_load', array(
			'logic' => $object
		));
	...
	protected function _beforeSave(Mage_Core_Model_Abstract $object) {
		...
		Mage::dispatchEvent('webforms_logic_before_save', array(
			'logic' => $object
		));
